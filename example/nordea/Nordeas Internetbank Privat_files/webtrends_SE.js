...
// Created: 1/26/2011 9:25:10 AM

function WebTrends() {
    var that = this;
    // begin: user modifiable
    this.dcsid = "dcsxpehghvz5bdof171e917on_5x6c";
    this.domain = "statse.webtrendslive.com";
    this.timezone = 1;
    this.fpcdom = "";
    this.onsitedoms = (function() {
        return(window.RegExp ? new RegExp("nordea.se", "i") : "");
    })();
    this.downloadtypes = "xls,doc,pdf,txt,csv,zip,docx,ppt,pptx,xlsx";
...
function getURI() {
    create_breadcrumbs();
    var uri_cg_n = _tag.WT.cg_n;
    uri_cg_n = uri_cg_n.replace("PN - ", "");
    var uri_cg_s = _tag.WT.cg_s;
    uri_cg_s = uri_cg_s.replace("PN - ", "");
    var uri_cg_s3 = _tag.DCSext.cg_s3;
    uri_cg_s3 = uri_cg_s3.replace("PN - ", "");
    var uri_cg_s4 = _tag.DCSext.cg_s4;
    uri_cg_s4 = uri_cg_s4.replace("PN - ", "");
    var uri = '/' + uri_cg_n + '/';
    if (uri_cg_s !== uri_cg_n) {
        uri = uri + uri_cg_s + '/';
        if (uri_cg_s3 !== uri_cg_s) {
            uri = uri + uri_cg_s3 + '/';
        }
        if (uri_cg_s4 !== uri_cg_s3) {
            uri = uri + uri_cg_s4 + '/';
        }
    }
    uri = uri + pageId;
